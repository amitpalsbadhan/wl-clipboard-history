...
echo ""
echo "=================================================="
echo " Setup Instructions for Hyprland (Lua 2026):"
echo "=================================================="
echo "1. Add a keybinding to open the history popup:"
echo "   hl.bind(mainMod .. \" + V\", hl.dsp.exec_cmd(\"wl-clipboard-history-gui\"))"
echo ""
echo "2. Add window rules to style/position the popup beautifully:"
echo "   hl.exec_cmd(\"pkill -f wl-clipboard-history-daemon; wl-clipboard-history-daemon &\")"
echo "   hl.exec_cmd(\"hyprctl keyword windowrulev2 float,title:^(Clipboard History)$\")"
echo "   hl.exec_cmd(\"hyprctl keyword windowrulev2 size 450 500,title:^(Clipboard History)$\")"
echo "   hl.exec_cmd(\"hyprctl keyword windowrulev2 move cursor -50% -50%,title:^(Clipboard History)$\")"
echo "   hl.exec_cmd(\"hyprctl keyword windowrulev2 pin,title:^(Clipboard History)$\")"
echo "   hl.exec_cmd(\"hyprctl keyword windowrulev2 stayfocused,title:^(Clipboard History)$\")"
echo "=================================================="
