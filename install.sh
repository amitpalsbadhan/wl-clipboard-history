...
echo "=================================================="
echo "1. Start tracker daemon inside hyprland.start:"
echo "   hl.on(\"hyprland.start\", function()"
echo "       hl.exec_cmd(\"wl-clipboard-history-daemon\")"
echo "   end)"
echo ""
...
echo "   hl.exec_cmd(\"hyprctl keyword windowrulev2 float,class:^(org.hyprland.wl-clipboard-history)$\")"
echo "   hl.exec_cmd(\"hyprctl keyword windowrulev2 size 450 500,class:^(org.hyprland.wl-clipboard-history)$\")"
echo "   hl.exec_cmd(\"hyprctl keyword windowrulev2 center,class:^(org.hyprland.wl-clipboard-history)$\")"
echo "   hl.exec_cmd(\"hyprctl keyword windowrulev2 pin,class:^(org.hyprland.wl-clipboard-history)$\")"
echo "   hl.exec_cmd(\"hyprctl keyword windowrulev2 stayfocused,class:^(org.hyprland.wl-clipboard-history)$\")"
echo "=================================================="
